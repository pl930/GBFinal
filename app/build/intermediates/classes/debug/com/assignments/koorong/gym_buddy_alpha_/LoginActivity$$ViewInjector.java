...
public class LoginActivity$$ViewInjector<T extends com.assignments.koorong.gym_buddy_alpha_.LoginActivity> implements Injector<T> {
  @Override public void inject(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131558502, "field '_loginButton'");
    target._loginButton = finder.castView(view, 2131558502, "field '_loginButton'");
    view = finder.findRequiredView(source, 2131558503, "field '_signupLink'");
    target._signupLink = finder.castView(view, 2131558503, "field '_signupLink'");
  }
