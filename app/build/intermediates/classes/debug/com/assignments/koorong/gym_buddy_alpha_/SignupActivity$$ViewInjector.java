...
public class SignupActivity$$ViewInjector<T extends com.assignments.koorong.gym_buddy_alpha_.SignupActivity> implements Injector<T> {
  @Override public void inject(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131624062, "field '_nameText'");
    target._nameText = finder.castView(view, 2131624062, "field '_nameText'");
    ...
    view = finder.findRequiredView(source, 2131624064, "field '_signupButton'");
    target._signupButton = finder.castView(view, 2131624064, "field '_signupButton'");
    view = finder.findRequiredView(source, 2131624065, "field '_loginLink'");
    target._loginLink = finder.castView(view, 2131624065, "field '_loginLink'");
  }
